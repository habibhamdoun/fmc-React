      ...
      transition={{duration:0.4}}
        >
          ...
          <div className="quote__field">
              <label className='label'>{t("quoteLocation")}</label>
              <input 
                value={location} 
              ...
              />
              <label className='label'>{t('quoteCompanyName')}</label>
              <input 
                value={companyName} 
              ...
              <label className='label'>{t("quotePhoneNumber")}</label>
              <input 
                value={PhoneNumber} 
