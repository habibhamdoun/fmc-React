    ...
    >
        ...
        <div className="services__title">
            <div className="title">
                ...
                <h2 className="title__header">{t("servicesTitle")}</h2>
                <div className="line line--blue"></div>
            </div>
        </div>
        <Alert 
            ...
            <div className="flip-card">
                <div className="flip-card-inner">
                    <div className="icon__container flip-card-front">
                        ...
                        <h4 className="icon__header">{t("service1Title")}</h4>
                    </div>
                    <div className={i18n.language=='ar'?"flip-card-back arabic":"flip-card-back"}>
                        <p>{t("service1Text")}</p>
                    </div>
                </div>
            </div>
            <div className="flip-card">
                <div className="flip-card-inner">
                    <div className="icon__container flip-card-front">
                        ...
                        <h4 className="icon__header">{t("service2Title")}</h4>
                    </div>
                    <div className={i18n.language=='ar'?"flip-card-back arabic":"flip-card-back"}>
                        <p>{t("service2Text")}</p>
                    </div>
            ...
            <div className="flip-card">
                <div className="flip-card-inner">
                    <div className="icon__container flip-card-front">
                        ...
                        <h4 className="icon__header">{t("service3Title")}</h4>
                    </div>
                    <div className={i18n.language=='ar'?"flip-card-back arabic":"flip-card-back"}>
                        {more === '1' ?<p>{t("service3TextExtended")}</p> :<p>{t("service3Text")}</p>} <a onClick={()=>{
                            more ==='1' ? setMore('0') : setMore('1')
                        }} className='more__btn'>{more==='1' ? <p>{t("lessBtn")}</p>:<p>{t('moreBtn')}</p>}</a>
            ...
            <div className="flip-card">
                <div className="flip-card-inner">
                    <div className="icon__container flip-card-front">
                        ...
                        <h4 className="icon__header">{t("service4Title")}</h4>
                    </div>
                    <div className={i18n.language=='ar'?"flip-card-back arabic":"flip-card-back"}>
                        {more ==='2' ?<p>{t("service4TextExtended")}</p> : <p>{t("service4Text")}</p>} <a onClick={()=>{
                            more ==='2' ? setMore('0') : setMore('2')
                        }} className='more__btn'>{more==='2' ? <p>{t("lessBtn")}</p>:<p>{t("moreBtn")}</p>}</a>
                    </div>
                </div>
            </div>
            <div className="flip-card">
                <div className="flip-card-inner">
                    <div className="icon__container flip-card-front">
                        ...
                        <h4 className="icon__header">{t("service5Title")}</h4>
                    </div>
                    <div className={i18n.language=='ar'?"flip-card-back arabic":"flip-card-back"}>
                        <p>{t("service5Text")}</p>
                    </div>
            ...
            <div className="flip-card">
                <div className="flip-card-inner">
                    <div className="icon__container flip-card-front">
                        ...
                        <h4 className="icon__header">{t("service6Title")}</h4>
                    </div>
                    <div className={i18n.language=='ar'?"flip-card-back arabic":"flip-card-back"}>
                        <p>{t("service6Text")}</p>
                    </div>
            ...
            <div className="flip-card">
                <div className="flip-card-inner">
                    <div className="icon__container flip-card-front">
                        ...
                        <h4 className="icon__header">{t("service7Title")}</h4>
                    </div>
                    <div className={i18n.language=='ar'?"flip-card-back arabic":"flip-card-back"}>
                        {more ==='3' ?<p>{t("service7TextExtended")}</p> : <p>{t("service7Text")}</p>} <a onClick={()=>{
                            more ==='3' ? setMore('0') : setMore('3')
                        }} className='more__btn'>{more==='3' ? <p>{t("lessBtn")}</p>:<p>{t("moreBtn")}</p>}</a>
            ...
            <div className="flip-card">
                <div className="flip-card-inner">
                    <div className="icon__container flip-card-front">
                        ...
                        <h4 className="icon__header">{t("service8Title")}</h4>
                    </div>
                    <div className={i18n.language=='ar'?"flip-card-back arabic":"flip-card-back"}>
                         {more ==='4' ?<p>{t("service8TextExtended")}</p>: <p>{t("service8Text")}</p>} <a onClick={()=>{
                            more ==='4' ? setMore('0') : setMore('4')
                        }} className='more__btn'>{more==='4' ? <p>{t("lessBtn")}</p>:<p>{t("moreBtn")}</p>}</a>
            ...
            <div className="flip-card">
                <div className="flip-card-inner">
                    <div className="icon__container flip-card-front">
                        ...
                        <h4 className="icon__header">{t("service9Title")}</h4>
                    </div>
                    <div className={i18n.language=='ar'?"flip-card-back arabic":"flip-card-back"}>
                        <p>{more ==='5' ?<p>{t("service9TextExtended")}</p> : <p>{t("service9Text")}</p>} <a onClick={()=>{
                            more ==='5' ? setMore('0') : setMore('5')
                        }} className='more__btn'>{more==='5' ? <p>{t("lessBtn")}</p>:<p>{t("moreBtn")}</p>}</a></p>
            ...
            <div className="flip-card">
                <div className="flip-card-inner">
                    <div className="icon__container flip-card-front">
                        ...
                        <h4 className="icon__header">{t("service10Title")}</h4>
                    </div>
                    <div className={i18n.language=='ar'?"flip-card-back arabic":"flip-card-back"}>
                        {more === '6' ?<p>{t("service10TextExtended")}</p> : <p>{t("service10Text")}</p>} <a onClick={()=>{
                            more ==='6' ? setMore('0') : setMore('6')
                        }} className='more__btn'>{more==='6' ? <p>{t("lessBtn")}</p>:<p>{t("moreBtn")}</p>}</a>
            ...
            <div className="flip-card">
                <div className="flip-card-inner">
                    <div className="icon__container flip-card-front">
                        ...
                        <h4 className="icon__header">{t("service11Title")}</h4>
                    </div>
                    <div className={i18n.language=='ar'?"flip-card-back arabic":"flip-card-back"}>
                        {more ==='7' ?<p>{t("service11TextExtended")}"</p> : <p>{t("service11Text")}</p>}<a onClick={()=>{
                            more ==='7' ? setMore('0') : setMore('7')
                        }} className='more__btn'>{more==='7' ? <p>{t("lessBtn")}</p>:<p>{t("moreBtn")}</p>}</a>
                    </div>
                </div>
            </div>
        </div>
